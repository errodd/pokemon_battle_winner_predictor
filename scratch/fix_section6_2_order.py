...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# 3. Análisis de superposición de Pokémon entre ambos grupos\n",
    ...
    "print(f\"Superposición de Pokémon: {len(overlap_pkmn)} de {len(pkmn_var)} Pokémon del grupo variable ({len(overlap_pkmn)/len(pkmn_var)*100:.1f}%) también están en el grupo determinista.\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "Una vez identificados los dos subgrupos en la gráfica anterior, realizamos un análisis comparativo cruzado para determinar qué diferencia a las parejas donde el ganador cambia de aquellas donde el ganador es constante:\n",
    "\n",
    "1. **Superposición de Pokémon (99.4%):**  \n",
    ...
    "   - *Conclusión de pertenencia:* No existe un grupo de Pokémon \"variables por naturaleza\". Un Pokémon se vuelve sensible a la posición `First_Pokemon` únicamente cuando enfrenta a un rival específico con características muy semejantes.\n",
    "\n",
    "2. **Factor Determinante 1: Empates en Velocidad (`Speed Ties`):**  \n",
    "   - En el grupo variable (donde el ganador cambia al invertir posiciones), el **43.6% de las parejas tienen EXACTAMENTE LA MISMA VELOCIDAD** (`Speed_1 == Speed_2`), con una diferencia mediana de velocidad de apenas **5 puntos**.  \n",
    "   - En el grupo determinista, el **0.0% de las parejas presentan empates en velocidad**, registrando una diferencia mediana de **30 puntos**.\n",
    "\n",
    "3. **Factor Determinante 2: Margen de Atributos Totales (`Total Stats`):**  \n",
    "   - Las parejas variables representan combates entre Pokémon con un techo de poder muy cercano (diferencia mediana de 100 pts vs 120 pts en deterministas). Al no haber un Pokémon ampliamente más veloz o más fuerte, **dar el primer golpe (`First_Pokemon`) define el resultado**.\n",
    "\n",
    "| Característica de Dominio | Parejas Deterministas (94.0%) | Parejas Variables (6.0%) |\n",
    "| :--- | :--- | :--- |\n",
    "| **Parejas Únicas Reenfrentadas** | 1,712 parejas | 110 parejas |\n",
    "| **Superposición de Pokémon Únicos** | 777 Pokémon | 169 Pokémon *(99.4% presentes en el otro grupo)* |\n",
    "| **Frecuencia de Empates en Velocidad (`Speed_1 == Speed_2`)** | **0.0%** | **43.6%** |\n",
    "| **Diferencia Mediana de Velocidad (`Speed`)** | **30 puntos** | **5 puntos** |\n",
    "| **Diferencia Mediana de Stats Totales (`Total_Stats`)** | **120 puntos** | **100 puntos** |"
   ]
  },
  {
   "cell_type": "markdown",
...
print('Updated Section 6.2 order: Definitions -> Code & Chart -> Comparative Analysis successfully!')
