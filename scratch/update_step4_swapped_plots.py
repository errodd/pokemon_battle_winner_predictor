...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "same_winner_swapped = (swapped_groups == 1).sum()\n",
    "diff_winner_swapped = (swapped_groups > 1).sum()\n",
    ...
    "        )\n",
    "\n",
    "# Gráfico 2: Efecto de la Inversión de Posiciones (Enfrentamientos Invertidos)\n",
    "swapped_series = pd.Series({\n",
    "    'Mismo Ganador Absoluto\\n(94.0%)': same_winner_swapped,\n",
    "    'Ganador Cambia por Inversión\\n(6.0%)': diff_winner_swapped\n",
    "})\n",
    "\n",
    ...
    ")\n",
    "axes[1].set_title('Efecto de la Inversión de Posiciones en Enfrentamientos Repetidos', fontsize=12, fontweight='bold')\n",
    "\n",
    "plt.tight_layout()\n",
    "plt.show()"
   ]
  ...
  },
  {
   ...
   "source": [
    ...
    ">    - En el **6.0% (110 parejas)** restante, el ganador cambia al invertir las posiciones, demostrando el efecto directo del **primer movimiento (`First_Pokemon`)** cuando los Pokémon tienen características extremadamente parejas. Por ende, los combates duplicados representan simulaciones legítimas y **no deben ser eliminados**.\n",
    ">\n",
...
print('Updated Section 6.2 with exact terms and swapped position graphics successfully!')
