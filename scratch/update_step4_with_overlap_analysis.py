...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "### 6.2.1 Análisis Comparativo de Subgrupos: Determinismo vs Sensibilidad a la Posición\n",
    "Realizamos un análisis cruzado entre el grupo de **Parejas Deterministas (94.0%)** y el grupo de **Parejas Variables (6.0%)** para caracterizar qué diferencia a ambos tipos de enfrentamientos:\n",
    "- **Superposición de Pokémon (99.4%):** 168 de los 169 Pokémon que participan en parejas variables TAMBIÉN están presentes en el grupo determinista al enfrentar a otros oponentes. **Conclusión:** No existe un subconjunto aislado de Pokémon \"variables\"; la variabilidad depende del rival específico.\n",
    "- **Empates en Velocidad (`Speed Ties`):** En el grupo variable, el **43.6% de las parejas tienen exactamente la misma Velocidad** (`Speed_1 == Speed_2`) con una diferencia mediana de velocidad de apenas **5 puntos**. En cambio, el grupo determinista presenta **0.0% empates en velocidad** y una diferencia mediana de **30 puntos**.\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# --- Visualización Gráfica Única e Impactante del Efecto de Inversión ---\n",
...
print('Updated Section 6.2 with overlap analysis and comparison table successfully!')
