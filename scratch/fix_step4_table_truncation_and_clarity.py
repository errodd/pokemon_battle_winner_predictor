...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# 3. Tabla Resumen Comparativa con nombres de métricas formateados sin truncamiento\n",
  ...
  },
  {
   ...
   "source": [
    ...
    ">\n",
    "> 3. **Empates en Velocidad (`Speed Ties`):**  \n",
    ">    - En las 110 parejas variables, el **43.6% presentan exactamente la misma velocidad** (`Speed_1 == Speed_2`), con una diferencia mediana de apenas **5 puntos**.  \n",
    ">    - En las 1,712 parejas deterministas, el **0.0% presentan empates en velocidad**, registrando una diferencia mediana de **30 puntos**."
   ]
  },
  {
   "cell_type": "markdown",
...
print('Updated table formatting and term clarity successfully!')
