...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "2. **Enfrentamientos Repetidos por Pareja (Reenfrentamientos / Re-matches):**  \n",
    "   - **Definición:** Ocurre cuando la misma pareja de Pokémon (`First_pokemon` y `Second_pokemon`) se enfrenta en múltiples ocasiones en el dataset. Nos permite evaluar la **estocasticidad vs determinismo**: ¿el ganador siempre es el mismo en cada reenfrentamiento, o el resultado cambia?\n",
    "   - **Ejemplo Concreto:**  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# --- Visualización Gráfica en la misma sección 6.2 ---\n",
    "fig, axes = plt.subplots(1, 2, figsize=(14, 5.5))\n",
    "\n",
    "# Gráfico 1: Distribución del resultado (Winner_Is_First) en Combates Exactamente Duplicados\n",
    "sns.countplot(\n",
    "    data=exact_dup_df, \n",
    "    x='Winner_Is_First', \n",
    "    ax=axes[0], \n",
    ...
    "    legend=False\n",
    ")\n",
    "axes[0].set_title('Distribución de Ganadores en Combates Exactamente Duplicados', fontsize=12, fontweight='bold')\n",
    "axes[0].set_xticks([0, 1])\n",
    "axes[0].set_xticklabels(['Gana Second_pokemon (0)', 'Gana First_pokemon (1)'])\n",
    "axes[0].set_xlabel('Resultado del Combate (Winner_Is_First)')\n",
    ...
    "        )\n",
    "\n",
    "# Gráfico 2: Tasa de Determinismo en Enfrentamientos Repetidos por Pareja\n",
    ...
    ")\n",
    "axes[1].set_title('Determinismo en Enfrentamientos Repetidos por Pareja', fontsize=12, fontweight='bold')\n",
    "\n",
    "plt.tight_layout()\n",
    "plt.show()"
   ]
  ...
  },
  {
   ...
   "source": [
    ...
    ">\n",
    "> 2. **Determinismo Absoluto en Enfrentamientos Repetidos por Pareja (100% Determinista):**  \n",
    ">    - El análisis gráfico dentro de la Sección 6.2 demuestra de forma contundente que el **100% de las 1,906 parejas** de Pokémon que se enfrentaron más de una vez registraron **EXACTAMENTE EL MISMO GANADOR** en todas sus batallas.  \n",
...
print('Updated chart titles to match section terms exactly!')
