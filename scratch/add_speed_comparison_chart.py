...
cells_list = [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# 4. Visualización Gráfica Comparativa de la Diferencia de Velocidad (Boxplot + KDE Plot)\n",
    ...
    "axes[0].set_xlabel('')\n",
    "\n",
    "# Subgráfico B: Curva de Densidad de Frecuencia (KDE Plot)\n",
    "sns.kdeplot(\n",
    "    data=all_metrics_df, \n",
    "    x='Delta_Speed', \n",
    "    hue='Grupo', \n",
    ...
    "    alpha=0.3\n",
    ")\n",
    "axes[1].set_title('Distribución de Densidad de la Diferencia de Velocidad', fontsize=12, fontweight='bold')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    ">    - Como demuestra la gráfica de **Boxplot y Densidad de Frecuencia (KDE Plot)** superior, el grupo de **Parejas Variables (6.0%)** presenta una altísima concentración de observaciones en **0 a 5 puntos de diferencia de velocidad**, registrando un **43.6% de empates exactos (`Speed_1 == Speed_2`)**.\n",
...
print('Added speed comparison plots (Boxplot + KDE Plot) to Section 6.2.1 successfully!')
